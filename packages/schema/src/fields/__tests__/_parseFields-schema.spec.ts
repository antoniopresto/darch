...
//   date
assert<IsExact<InferField<{ schema: { name: 'date' } }>, { name: Date }>>(true);
...
//   null:
assert<IsExact<InferField<{ schema: { name: 'null' } }>, { name: null }>>(true);
...
//   unknown:
assert<IsExact<InferField<{ schema: { name: 'unknown' } }>, { name: unknown }>>(
  true
);
...
//   enum:
assert<IsExact<InferField<{ schema: { name: '[enum]' } }>, { name: never[] }>>(
  true
);
//
